...
public:
  ...
  // and value are separated by the sequence space-colon-space " : ". The pairs
  // are arranged in order, as defined by the order operator <.
  std::string to_string() const;

  // pre_string()
  // Returns a string consisting of all keys in this Dictionary. The key order
  // is given by a pre-order tree walk. The keys stored in black Nodes will
  // appear in the returned string as "key\n", and the keys stored in red Nodes
  // will appear as "key (RED)\n".  The output of this function is demonstrated
  // in /Examples/pa8/DictionaryClient-out.
